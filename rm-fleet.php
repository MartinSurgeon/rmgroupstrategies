<?php
/**
 * RM Group Strategies LLC — RM Fleet Division Page (Coming Soon)
 */
...
<head>
    ...
    <!-- SEO -->
    <title>RM Fleet | Fleet Management & Leasing | <?php echo SITE_NAME; ?></title>
    <meta name="description" content="RM Fleet - Commercial fleet leasing, vehicle acquisition, and maintenance management. Full division portal coming soon.">
...
<body class="bg-slate-50 font-inter text-slate-800 antialiased selection:bg-brand-gold selection:text-white">
    ...
    <section class="min-h-[70vh] flex items-center justify-center bg-brand-navy py-20 px-4 text-white relative overflow-hidden">
        <div class="absolute inset-0 z-0 opacity-20">
            <img src="<?php echo BASE_URL; ?>/assets/images/rm-fleet.png" alt="RM Fleet Preview" class="w-full h-full object-cover">
        </div>
        ...
        <div class="max-w-2xl mx-auto text-center relative z-10">
            ...
            <p class="text-lg text-slate-300 leading-relaxed mb-8">
                Commercial fleet management, vehicle leasing solutions, and government fleet support portal is currently under development. Full page coming soon.
            </p>
            <div class="bg-[#0F172A] border border-brand-gold/30 rounded-2xl p-8 shadow-2xl mb-8">
                <h2 class="text-xl font-bold text-white mb-2">Fleet Support &amp; Fleet Inquiries</h2>
                <p class="text-slate-400 text-xs leading-relaxed mb-6">For commercial fleet inquiries, vehicle procurement, or fleet management assistance, contact our team directly.</p>
                <a href="<?php echo BASE_URL; ?>/contact.php?type=consultation&sector=fleet_management" class="btn-gold text-xs uppercase tracking-widest font-bold py-3.5 px-8 inline-flex items-center gap-2">
