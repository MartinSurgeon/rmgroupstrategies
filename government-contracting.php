...
<body class="font-inter bg-brand-black text-brand-white">
    ...
    <main>
        ...
        <!-- ═══════════════════════════════════════════════════════
             ...
             ═══════════════════════════════════════════════════════ -->
        <section id="identifiers" class="bg-brand-black py-20">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="animate-on-scroll">
                    <div class="section-heading">
                        <h2>Identifiers &amp; Classifications</h2>
                        <div class="gold-divider-lg"></div>
                        <p>Core company registration codes and classifications for government procurement officers.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 animate-on-scroll mt-8">
                    ...
                    <div class="stagger-child bg-brand-dark-gray/40 border border-white/5 rounded-xl p-6 relative overflow-hidden">
                        <div class="absolute top-0 left-0 w-1 h-full bg-brand-gold"></div>
                        <h3 class="text-white font-bold text-sm tracking-wider uppercase mb-5 pb-2 border-b border-white/5">
                            Registration Status
                        </h3>
                        <ul class="space-y-4">
                            <li class="flex items-start justify-between text-xs">
                                <span class="text-white/40">SAM.gov Status</span>
                                <span class="font-semibold text-green-400 bg-green-500/10 px-2.5 py-0.5 rounded-full border border-green-500/20">Active Registration</span>
                            </li>
                            <li class="flex items-start justify-between text-xs">
                                <span class="text-white/40">UEI Number</span>
                                <span class="font-semibold text-brand-gold">Available Upon Request</span>
                            </li>
                            <li class="flex items-start justify-between text-xs">
                                <span class="text-white/40">CAGE Code</span>
                                <span class="font-semibold text-brand-gold">Available Upon Request</span>
                            </li>
                            <li class="flex items-start justify-between text-xs">
                                <span class="text-white/40">Federal Contract Ready</span>
                    ...
                    <div class="stagger-child bg-brand-dark-gray/40 border border-white/5 rounded-xl p-6 relative overflow-hidden">
                        ...
                        <ul class="space-y-3 text-xs">
                            <li class="flex items-start gap-3">
                                ...
                                <span class="text-white/70">Administrative Management and General Management Consulting Services (Primary)</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="font-bold text-brand-gold">484110</span>
                                <span class="text-white/70">General Freight Trucking, Local</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="font-bold text-brand-gold">484121</span>
                                <span class="text-white/70">General Freight Trucking, Long-Distance</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="font-bold text-brand-gold">488490</span>
                                <span class="text-white/70">Other Support Activities for Road Transportation</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="font-bold text-brand-gold">236118</span>
                                <span class="text-white/70">Residential Remodelers</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="font-bold text-brand-gold">236220</span>
                                <span class="text-white/70">Commercial and Institutional Building Construction</span>
                            </li>
                            <li class="flex items-start gap-3">
                                <span class="font-bold text-brand-gold">532412</span>
                                <span class="text-white/70">Construction, Mining, and Forestry Machinery and Equipment Rental and Leasing</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="stagger-child bg-brand-dark-gray/40 border border-white/5 rounded-xl p-6 relative overflow-hidden">
                        ...
                        <ul class="space-y-4 text-xs">
                            <li class="flex items-start justify-between">
                                <span class="text-white/40">Business Structure</span>
                                <span class="font-semibold text-white">Limited Liability Company (LLC)</span>
                            </li>
                            <li class="flex items-start justify-between">
                                <span class="text-white/40">Socio-Economic Category</span>
                                <span class="font-semibold text-white">Self-Certified Small Business</span>
                            </li>
                            <li class="flex items-start justify-between">
                                <span class="text-white/40">State of Incorporation</span>
                                <span class="font-semibold text-white">Nevada</span>
                            </li>
                            <li class="flex items-start justify-between">
                                <span class="text-white/40">Service Category</span>
                                <span class="font-semibold text-white">Diversified Services Group</span>
                            </li>
                        </ul>
                    </div>
        ...
        <!-- ═══════════════════════════════════════════════════════
             ...
             ═══════════════════════════════════════════════════════ -->
        <section id="capabilities" class="bg-brand-dark-gray py-20 lg:py-28">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="animate-on-scroll">
                    <div class="section-heading">
                        <h2>Core Capabilities</h2>
                        <div class="gold-divider-lg"></div>
                        <p>We deliver specialized execution and project oversight capabilities across our primary operational divisions.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 animate-on-scroll">
                    ...
                    <!-- Capability 1 -->
                    <div class="stagger-child card-hover bg-brand-black rounded-lg border border-white/5 p-6">
                        <div class="w-10 h-10 mb-4 rounded bg-brand-gold/10 flex items-center justify-center">
                        ...
                        <h3 class="text-white font-semibold text-sm mb-2 tracking-wide">General Contracting</h3>
                    ...
                    <div class="stagger-child card-hover bg-brand-black rounded-lg border border-white/5 p-6">
                        ...
                        <h3 class="text-white font-semibold text-sm mb-2 tracking-wide">Facility Maintenance</h3>
                        <p class="text-white/50 text-xs leading-relaxed">
                    ...
                    <div class="stagger-child card-hover bg-brand-black rounded-lg border border-white/5 p-6">
                        ...
                        <h3 class="text-white font-semibold text-sm mb-2 tracking-wide">Fleet Support Services</h3>
                        <p class="text-white/50 text-xs leading-relaxed">
                    ...
                    <div class="stagger-child card-hover bg-brand-black rounded-lg border border-white/5 p-6">
                        ...
                        <h3 class="text-white font-semibold text-sm mb-2 tracking-wide">Construction Services</h3>
                        <p class="text-white/50 text-xs leading-relaxed">
                    ...
                    <div class="stagger-child card-hover bg-brand-black rounded-lg border border-white/5 p-6">
                        ...
                        <h3 class="text-white font-semibold text-sm mb-2 tracking-wide">Administrative Support</h3>
                        <p class="text-white/50 text-xs leading-relaxed">
                    ...
                    <div class="stagger-child card-hover bg-brand-black rounded-lg border border-white/5 p-6">
                        ...
                        <h3 class="text-white font-semibold text-sm mb-2 tracking-wide">Procurement Assistance</h3>
                        <p class="text-white/50 text-xs leading-relaxed">
        ...
        <!-- ═══════════════════════════════════════════════════════
             ...
             ═══════════════════════════════════════════════════════ -->
        <section id="why-work-with-us" class="bg-brand-black py-20 lg:py-28">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                    ...
                    <div class="space-y-4 animate-on-scroll">
                        <!-- Bullet 1 -->
                        <div class="stagger-child flex gap-4 bg-brand-dark-gray/30 p-4 rounded border border-white/5">
                            ...
                            <div>
                                <h4 class="text-white font-bold text-xs uppercase tracking-wider mb-1">FAR Regulatory Alignment</h4>
                                <p class="text-white/50 text-[11px] leading-relaxed">We strictly adhere to Federal Acquisition Regulations (FAR) and project parameters.</p>
                            </div>
                        </div>
                        ...
                        <div class="stagger-child flex gap-4 bg-brand-dark-gray/30 p-4 rounded border border-white/5">
                            <svg class="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296"/></svg>
                            <div>
                                <h4 class="text-white font-bold text-xs uppercase tracking-wider mb-1">Schedule &amp; Quality Control</h4>
                                <p class="text-white/50 text-[11px] leading-relaxed">Unified project oversight structures ensure field safety, quality controls, and clean timelines.</p>
                            </div>
                        </div>
                        ...
                        <div class="stagger-child flex gap-4 bg-brand-dark-gray/30 p-4 rounded border border-white/5">
                            <svg class="w-5 h-5 text-brand-gold flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 01-1.043 3.296"/></svg>
                            <div>
                                <h4 class="text-white font-bold text-xs uppercase tracking-wider mb-1">Detailed Operational Reporting</h4>
                                <p class="text-white/50 text-[11px] leading-relaxed">Centralized accounting and reporting systems supply clean audits and project compliance documentation.</p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- ═══════════════════════════════════════════════════════
             ...
             ═══════════════════════════════════════════════════════ -->
        <section id="vehicles" class="bg-brand-dark-gray py-20 lg:py-28">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="animate-on-scroll">
                    <div class="section-heading">
                        <h2>Contract Vehicles</h2>
                        <div class="gold-divider-lg"></div>
                        <p>We are equipped to execute contracts and coordinate partnerships across multiple organizational tiers.</p>
                    </div>
                </div>
        ...
        <section id="cta" class="bg-brand-black py-20 lg:py-28 relative overflow-hidden">
            ...
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="border border-brand-gold/20 bg-brand-dark-gray/20 rounded-2xl p-8 sm:p-12 text-center animate-on-scroll">
